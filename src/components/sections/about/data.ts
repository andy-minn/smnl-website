export const aboutSMNLSection = {
  title: "About Us",

  subheading1_1: "Connecting Businesses Through ",
    ...
    points: [
      {
        ...
        description:
          "We work with trusted suppliers across our sourcing markets and coordinate product requirements according to customer needs.",
      },
      {
        title: "Cross-Border Coordination",
        description:
          "We coordinate payments, transportation, shipments and deliveries across international markets.",
      },
      {
        title: "Product Requirements",
        description:
          "We check product specifications and help ensure purchased products meet the requirements agreed with customers.",
      },
    ],
  },
