...
export const servicesSectionData = {
  ...
  services: [
...

    {
      title: "Plywood",
      briefDescription:
        "Sourced from reliable suppliers according to customer requirements and product specifications.",
      visual: img2,
      imageAlt:
...

    {
      title: "BlockBoard",
      briefDescription:
        "Sourced according to customer requirements for interior decoration and building applications.",
      visual: img3,
      imageAlt:
